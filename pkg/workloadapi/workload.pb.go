...
type GatewayAddress struct {
	...
	// port to reach the gateway using plaintext PROXY protocol
	// used in conjunction with hbone_mtls_port targeting the ztunnel
	// A value of 0 = unset
	ProxyProtocolPort uint32 `protobuf:"varint,5,opt,name=proxy_protocol_port,json=proxyProtocolPort,proto3" json:"proxy_protocol_port,omitempty"`
}
...
func (x *GatewayAddress) GetProxyProtocolPort() uint32 {
	if x != nil {
...
var file_workloadapi_workload_proto_rawDesc = []byte{
	...
	0x74, 0x50, 0x6f, 0x72, 0x74, 0x22, 0xa8, 0x02, 0x0a, 0x0e, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61,
	...
	0x74, 0x12, 0x2e, 0x0a, 0x13, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x63, 0x6f, 0x6c, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x11,
	0x70, 0x72, 0x6f, 0x78, 0x79, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x50, 0x6f, 0x72,
